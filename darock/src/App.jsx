...
export const App = () => {
  ...
  const setCookie = () => {pressed[0] = 1; document.getElementById("cookie").style.backgroundColor = "green"}
  const setGame = () => {pressed[1] = 1; document.getElementById("game").style.backgroundColor = "green"}
  const setSleep = () => {pressed[2] = 1; document.getElementById("sleep").style.backgroundColor = "green"}
  const setStudy = () => {pressed[3] = 1; document.getElementById("study").style.backgroundColor = "green"}
  ...
  useEffect(() => {
    ...
    function startGame() {
      ...
      document.getElementsByClassName("rock")[0].style.color = stateColors[state];
      ...
      var statusTimer = setInterval(function () {
        if (timeleft <= 0) {
          ...
          if (pressed[state] == 1) {
            ...
            document.getElementsByClassName("childBtn").forEach(element => {
  ...
  return (
    <>
      ...
      <div className="actionDiv">
        <button className="childBtn" id="cookie" onClick={setCookie}>feed cookie</button>
        <button className="childBtn" id="game" onClick={setGame}>play game</button>
        <button className="childBtn" id="sleep" onClick={setSleep}>sleep</button>
        <button className="childBtn" id="study" onClick={setStudy}>study</button>
      </div>
    </>
  );
};
